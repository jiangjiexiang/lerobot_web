...
.log-workspace { background:#f7f8f8; color:#34373a; }.log-toolbar,.log-body,.date-list,.log-list { border-color:#dedfe0; background:#fff; }.log-toolbar h2 { color:#303235; }.log-toolbar p,.date-list header,.date-list small,.log-filters span { color:#818589; }.actions button,.log-filters input,.log-filters select { border-color:#d7d9db; background:#fff; color:#4b5054; }.date-list { border-color:#e3e4e5; }.date-list button { color:#4e5357; }.date-list button.active { background:#eef4ff; box-shadow:inset 3px 0 #4b7dd2; }.log-list article { border-color:#e8e9ea; }.log-list time { color:#8b8f92; }.log-list code { color:#4c5660; }.level-dot { background:#47a97d; }
</style>
